...
class TrendingMovies: NSObject, Decodable {
    ...
    init(id: Int, adult: Bool, title: String, video: Bool = false, overview: String, popularity: Float, backdrop_path: String, poster_path: String, original_title: String, release_date: String, vote_count: Int, vote_average: Float, original_language: String, genre_ids: [Int], media_type : String) {
        self.id = id
        self.adult = adult
        self.title = title
        self.video = video
